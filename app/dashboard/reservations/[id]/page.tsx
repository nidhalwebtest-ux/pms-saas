              ...
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {reservation.invoices.map((inv) => {
                    // FIX: Calculate Partial Payments
                    ...
                    // Smart Status Override: If it's fully paid, show PAID even if DB hasn't synced yet
                    let displayStatus = inv.status;
                    if (remainingBalance <= 0) displayStatus = "PAID";
                    else if (
                      inv.status === "PENDING" &&
                      ...
                      displayStatus = "PARTIAL"; // Nice visual feedback

                    const isOverdue = displayStatus === "DUE";
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          {remainingBalance > 0 ? (
                            // Pass the invoiceId AND the exact remaining amount to the payment page
                            <Link
                              href={`/dashboard/reservations/${id}/payments/new?invoiceId=${inv.id}&amount=${remainingBalance}`}
