    ...
    <section id="features" data-screen-label="Solution" className="bg-gray-50 py-16 md:py-24">
      <Container>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {SOLUTIONS.map(({ visual, title, body }) => (
            <article
              key={title}
              className="group flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white p-7 transition-all duration-200 hover:-translate-y-1 hover:border-gray-300 hover:shadow-lg"
            >
              <div className="relative h-[180px] overflow-hidden rounded-md border border-gray-200 bg-gray-50">
                {visual}
              </div>
